...
VALUES (0, 'TEST_FIRSTNAME', 'TEST_LASTNAME', CURRENT_TIMESTAMP, 'TEST@TEST.COM', 'TEST_COUNTRY', 'UUID-0000');
...
INSERT INTO CONTEST(ID, CONTEST_ID, TITLE, START_TIME, END_TIME, PLACE, COUNTRY)
VALUES (0, 'UUID-0000', 'TEST CONTEST', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'TEST_PLACE', 'TEST_COUNTRY');
-- Таблица парапланов
...
VALUES (0, 0, 'UUID-0000', 'TEST_NUMBER', 'TEST_COUNTRY', 'TEST_GLIDER', 'UUID-0000', 'TEST_NAME');
...
VALUES (0, 'UUID-0000', 'paraglider', 'niviuk', 'UUID-0000', 'TEST DESCRIPTION');
-- Таблица транспорта
