...
ALTER SCHEMA AIRTRIBUNE_TEST OWNER TO AIRTRIBUNE;
SET SEARCH_PATH TO AIRTRIBUNE_TEST;
...
ALTER TABLE DEVICE_TYPE OWNER TO AIRTRIBUNE;
-- Вносим тестовый тип
...
ALTER TABLE TRACKER OWNER TO AIRTRIBUNE;
...
ALTER TABLE COUNTRY OWNER TO AIRTRIBUNE;
...
ALTER TABLE RACE OWNER TO AIRTRIBUNE;
...
ALTER TABLE CHECKPOINT OWNER TO AIRTRIBUNE;
...
ALTER TABLE HQ_ADDRESS OWNER TO AIRTRIBUNE;
...
ALTER TABLE CONTEST OWNER TO AIRTRIBUNE;
...
ALTER TABLE CONTACT_INFO OWNER TO AIRTRIBUNE;
...
ALTER TABLE ORGANIZATOR OWNER TO AIRTRIBUNE;
...
ALTER TABLE PARTICIPANT OWNER TO AIRTRIBUNE;
-- Тестовый участник
...
ALTER TABLE PARAGLIDER OWNER TO AIRTRIBUNE;
...
ALTER TABLE ASSIGNED_TRACKER OWNER TO AIRTRIBUNE;
...
ALTER TABLE TRACK OWNER TO AIRTRIBUNE;
...
ALTER TABLE TRACK_DATA OWNER TO AIRTRIBUNE;
...
ALTER TABLE TRANSPORT OWNER TO AIRTRIBUNE;
-- TODO