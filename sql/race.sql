...
-- Select race
SELECT
  ID, RACE_ID, TITLE, START_TIME, END_TIME, TIMEZONE, (SELECT TYPE FROM RACE_TYPE WHERE ID=RACE.RACE_TYPE), CHECKPOINTS
FROM RACE WHERE RACE_ID=%s;

-- Update race
UPDATE RACE SET (TITLE, START_TIME, END_TIME, TIMEZONE, RACE_TYPE, CHECKPOINTS) = (%s, %s, %s, %s,  (
